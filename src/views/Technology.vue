 ...
 export default {
   ...
   setup() {
     ...
     onMounted(async () => {
       ...
       products.value = await getData(`https://newsapi.org/v2/everything?q=technology&language=en&from=2023-11-10&apiKey=${localapiKey}`);
       products1.value = await getData(`https://newsapi.org/v2/everything?q=tesla&language=en&from=2023-11-12&apiKey=${localapiKey}`);
