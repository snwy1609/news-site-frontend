       ...
       <div class="row">
         ...
         <div class="col-4">
           ...
           <div class="row">
             <div v-if="products && products.articles">
               <div class="row">
                 <div v-for="(item, index) in products.articles.slice(10, 20)" :key="index" class="col-md-12" @click="redirect(item.url)">
                       <div class="col">
   ...
   export default {
     ...
     setup() {
       ...
       onMounted(async () => {
          ...
          products.value = await getData(`https://newsapi.org/v2/everything?q=health&language=en&from=2023-11-12&sortBy=popularity&maximum=50&apiKey=${localapiKey}`);
