<template>
       ...
       <div class="col-4 col-lg-4 col-md-4 col-sm-12 q-mt-lg q-pa-md">
         <div v-if="products && products.articles">
           <div class="row ">
             ...
             <div v-for="(item, index) in products.articles.slice(20, 24)" :key="index" class="col-md-12 col-sm-6" @click="redirect(item.url)">
               <div class="col">
     ...
     <div class="row">
       ...
       <div class="col-4">
         ...
         <div class="row">
           <div v-if="products && products.articles">
             <div class="row">
               <div v-for="(item, index) in products.articles.slice(30, 50)" :key="index" class="col-md-12" @click="redirect(item.url)">
                     <div class="col">
 ...
 <div class="col-6">
   <div class="row q-mt-sm text-h5 text-bold"  >
       ...
       <q-separator/>
   <div class="row"> 
     <div v-if="products1 && products1.articles">
     <div class="row">
       <div v-for="(item, index) in products1.articles.slice(5, 9)" :key="index" class="col-md-6" @click="redirect(item.url)">
         <div class="flex">
           <div class="col">
 ...
 export default {
   ...
   setup() {
     ...
     onMounted(async () => {
        ...
        products.value = await getData(`https://newsapi.org/v2/everything?q=general&from=2023-11-11&sortBy=publishedAt&apiKey=${localapiKey}`);
        products1.value = await getData(`https://newsapi.org/v2/everything?q=international&from=2023-11-11&sortBy=publishedAt&apiKey=${localapiKey}`);
