<template>
   ...
   <div class="col-6">
     ...
     <div class="row"> 
       ...
       <div class="row">
         <div v-for="(item, index) in products1.articles.slice(0, 9)" :key="index" class="col-md-6" @click="redirect(item.url)">
           <div class="flex">
             <div class="col">
   ...
   export default {
     ...
     setup() {
       ...
       onMounted(async () => {
         ...
         products.value = await getData(`https://newsapi.org/v2/everything?q=latest&language=en&from=2023-11-13&sortBy=popularity&apiKey=${localapiKey}`);
         products1.value = await getData(`https://newsapi.org/v2/everything?q=trends&language=en&from=2023-11-12&apiKey=${localapiKey}`);
